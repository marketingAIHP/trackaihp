...
export const AdminLoginScreen: React.FC<{navigation: any}> = ({navigation}) => {
  ...
  const {adminLoginAsync, loginError, isLoggingIn} = useAuth();
  ...
  const onSubmit = async (data: LoginFormData) => {
    setLocalError(null);
    try {
      await adminLoginAsync({email: data.email, password: data.password});
    } catch (error: any) {
          ...
          <View style={[styles.content, isWideWeb && styles.webContent]}>
            ...
            <View style={[styles.card, {backgroundColor: theme.colors.surface}, isWideWeb && styles.webCard]}>
              ...
              <View style={styles.switchFooter}>
                ...
                <Text
                  variant="bodyMedium"
                  style={[styles.switchLink, isWeb && styles.webLink]}
